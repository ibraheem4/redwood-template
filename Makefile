.PHONY: setup-env build up down clean test lint lint-fix install-deps-ci build-docker tag-docker publish-docker up-detached build-ci lint-ci test-ci clean-ci
